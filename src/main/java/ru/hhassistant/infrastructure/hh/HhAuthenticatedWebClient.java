...
public class HhAuthenticatedWebClient {
  ...
  public record LoginResult(boolean success, String hhtoken, String errorMessage) {
    ...
    static LoginResult failed(String msg) {
  ...
  private static final class CookieSession implements AutoCloseable {
    ...
    java.util.Map<String, String> getCookies() {
      return java.util.Map.copyOf(cookies);
    }

    void restoreCookies(java.util.Map<String, String> saved) {
      cookies.putAll(saved);
    }
